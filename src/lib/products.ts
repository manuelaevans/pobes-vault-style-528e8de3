...
export const PRODUCTS: Product[] = [
  ...
  {
    slug: "nike-air-max-triple-black",
    name: "Air Max — Triple Black",
    brand: "Nike",
    category: "Shoes",
    price: 950,
    images: ["/images/airmax-black.jpeg"],
    sizes: ["40", "41", "42", "43", "44", "45"],
    colours: ["Black"],
    inStock: true,
    badges: ["NEW"],
    addedIndex: 24,
    description:
      "All-black Air Max runner with a matte upper, tonal Swoosh and chunky visible Air sole. A stealthy everyday pair that goes with anything.",
  },
  {
    slug: "cork-buckle-sandals-black",
    name: "Cork Buckle Sandals — Black",
    brand: "Pobe's Select",
    category: "Slides",
    price: 420,
    images: ["/images/cork-sandals.webp"],
    sizes: ["40", "41", "42", "43", "44"],
    colours: ["Black"],
    inStock: true,
    badges: ["NEW"],
    addedIndex: 23,
    description:
      "Two-strap sandals with gold-tone buckles on a contoured cork footbed. Soft black straps, lightweight and easy to wear all day.",
  },
  {
